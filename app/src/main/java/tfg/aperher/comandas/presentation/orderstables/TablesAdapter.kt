...
class TablesAdapter(private val itemClicked: (Table, Boolean) -> Unit) : ListAdapter<Table, TablesAdapter.ViewHolder>(TableDiff) {
    ...
    inner class ViewHolder(private val binding: ItemTableBinding) :
        ...
        init {
            binding.root.setOnClickListener {
                ...
                itemClicked(table, !table.dateTime.isNullOrEmpty())
            }
        }
        ...
        fun bind(table: Table) {
            ...
            table.dateTime?.let { binding.tvInitTime.text = it }
